import { BadRequestException, Query, Render } from '@nestjs/common';
    ...
    if (army1 !== undefined && army2 !== undefined) {
      ...
      if (isNaN(army1Size) || isNaN(army2Size)) {
        throw new BadRequestException({
          message: 'Wrong input. Please, enter the numbers in inputs. ',
        });
        console.log(
          'You have entered wrong inputs. Please, enter the numbers in inputs.',
        );
      }
      ...
      const armyOne = this.appService.buildArmy(
        armyNationalities.nationality1,
        army1UnitSize.infantrySize,
        army1UnitSize.artillerySize,
        army1UnitSize.airforceSize,
        battleGround,
      );
      const armyTwo = this.appService.buildArmy(
        armyNationalities.nationality2,
        army2UnitSize.infantrySize,
        army2UnitSize.artillerySize,
        army2UnitSize.airforceSize,
        battleGround,
      );
      //perform combat
